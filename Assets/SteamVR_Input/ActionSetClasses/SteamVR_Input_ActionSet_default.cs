...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Vector2 RadialThumb
        {
            get
            {
                return SteamVR_Actions.default_RadialThumb;
            }
        }
        
        public virtual SteamVR_Action_Boolean ShowRadialMenu
        {
            get
            {
                return SteamVR_Actions.default_ShowRadialMenu;
            }
        }
        
        public virtual SteamVR_Action_Boolean ConfirmRadialMenu
        {
            get
            {
                return SteamVR_Actions.default_ConfirmRadialMenu;
            }
        }
